{
  ...
  inputs = {
    ...
    chaotic-kernel.url = "github:chaotic-cx/nyx/089a1f89a2846c1a4a601fc394d3713206ab1473";
    ...
    pyprland = { url = "git+https://github.com/hyprland-community/pyprland?ref=refs/tags/2.4.6"; };
