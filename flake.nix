{
  ...
  inputs = {
    ...
    chaotic-kernel.url = "github:chaotic-cx/nyx/7cc6282416833f2dea96f97f516aceadbf406404";
    ...
    hyprland = { url = "github:hyprwm/Hyprland/v0.37.1"; inputs.nixpkgs.follows = "nixpkgs-small"; };
