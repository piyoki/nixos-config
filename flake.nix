{
  ...
  inputs = {
    ...
    chaotic-kernel.url = "github:chaotic-cx/nyx/0d1cb79bc1fdae025f557f6c5053c69b35f4cc35";
    ...
    hyprland = { url = "github:hyprwm/Hyprland/v0.39.0"; inputs.nixpkgs.follows = "nixpkgs-small"; };
