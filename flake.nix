{
  ...
  inputs = {
    ...
    chaotic-kernel.url = "github:chaotic-cx/nyx/4a1d0470bacd2510708ef8f4ed2ac0061ea6fd80";
    ...
    hyprland = { url = "github:hyprwm/Hyprland/v0.38.0"; inputs.nixpkgs.follows = "nixpkgs-small"; };
